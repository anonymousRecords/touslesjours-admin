...
export function ReservationList({ reservations, onUpdate, onDelete }: ReservationListProps) {
  ...
  const renderCell = (reservation: Reservation, field: keyof Reservation, type = 'text') => {
        ...
        <tbody>
          {reservations.map((reservation) => (
            <tr key={reservation.id} className="hover:bg-gray-50">
              ...
              <td className="py-2 px-4 border-b">{renderCell(reservation, 'product')}</td>
              <td className="py-2 px-4 border-b">
                {renderCell(reservation, 'reservation_date', 'date')}
              </td>
              <td className="py-2 px-4 border-b">{renderCell(reservation, 'customer_name')}</td>
              <td className="py-2 px-4 border-b">
                {renderCell(reservation, 'customer_phone', 'tel')}
              </td>
              <td className="py-2 px-4 border-b">{renderCell(reservation, 'notes', 'textarea')}</td>
              <td className="py-2 px-4 border-b">
